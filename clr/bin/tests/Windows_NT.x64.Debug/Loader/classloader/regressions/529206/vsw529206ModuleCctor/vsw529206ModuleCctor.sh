...
then
    echo $CORE_ROOT/corerun "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../dasm/Loader/classloader/regressions/529206/vsw529206ModuleCctor vsw529206ModuleCctor.exe
    "$CORE_ROOT/corerun" "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../dasm/Loader/classloader/regressions/529206/vsw529206ModuleCctor vsw529206ModuleCctor.exe
    _jdExitCode=$?
    if [ $_jdExitCode -ne 0 ]
    then
