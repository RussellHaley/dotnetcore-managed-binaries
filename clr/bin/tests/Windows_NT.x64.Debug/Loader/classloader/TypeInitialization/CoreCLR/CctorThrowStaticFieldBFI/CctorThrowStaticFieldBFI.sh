...
then
    echo $CORE_ROOT/corerun "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../dasm/Loader/classloader/TypeInitialization/CoreCLR/CctorThrowStaticFieldBFI CctorThrowStaticFieldBFI.exe
    "$CORE_ROOT/corerun" "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../dasm/Loader/classloader/TypeInitialization/CoreCLR/CctorThrowStaticFieldBFI CctorThrowStaticFieldBFI.exe
    _jdExitCode=$?
    if [ $_jdExitCode -ne 0 ]
    then
