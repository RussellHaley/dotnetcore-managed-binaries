...
public class _varargsupport_varargsupport_
        {
            [Fact]
            public void _varargsupport_varargsupport_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\baseservices.varargs\varargsupport\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"varargsupport.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"varargsupport.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\varargsupport\varargsupport.cmd");
...
public class _varargsupport_r_varargsupport_r_
        {
            [Fact]
            public void _varargsupport_r_varargsupport_r_cmd()
            {
                ...
                {
                  CoreclrTestWrapperLib wrapper = new CoreclrTestWrapperLib();
                  string testSubfolder = @"\baseservices.varargs\varargsupport_r\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"varargsupport_r.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"varargsupport_r.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\varargsupport_r\varargsupport_r.cmd");
