...
public class _Compilation_Compilation_
        {
            ...
            public void _Compilation_Compilation_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\managed.Compilation\Compilation\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"Compilation.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"Compilation.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\Compilation\Compilation.cmd");
