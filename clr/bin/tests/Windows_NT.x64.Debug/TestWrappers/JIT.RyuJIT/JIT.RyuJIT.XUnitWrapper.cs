...
public class _DoWhileBndChk_DoWhileBndChk_
        {
            [Fact]
            public void _DoWhileBndChk_DoWhileBndChk_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\JIT.RyuJIT\DoWhileBndChk\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"DoWhileBndChk.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"DoWhileBndChk.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\DoWhileBndChk\DoWhileBndChk.cmd");
