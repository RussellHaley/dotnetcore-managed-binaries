...
public class _superpmicollect_superpmicollect_
        {
            ...
            public void _superpmicollect_superpmicollect_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\JIT.superpmi\superpmicollect\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"superpmicollect.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"superpmicollect.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\superpmicollect\superpmicollect.cmd");
