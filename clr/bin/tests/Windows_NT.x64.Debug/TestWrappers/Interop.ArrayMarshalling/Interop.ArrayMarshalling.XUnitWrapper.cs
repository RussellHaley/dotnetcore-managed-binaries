...
public class _ByValArray_MarshalArrayByValTest_MarshalArrayByValTest_
        {
            [Fact]
            public void _ByValArray_MarshalArrayByValTest_MarshalArrayByValTest_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\Interop.ArrayMarshalling\ByValArray\MarshalArrayByValTest\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"MarshalArrayByValTest.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"MarshalArrayByValTest.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\ByValArray\MarshalArrayByValTest\MarshalArrayByValTest.cmd");
