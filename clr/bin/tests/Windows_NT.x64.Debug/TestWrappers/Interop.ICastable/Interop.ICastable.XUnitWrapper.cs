...
public class _Castable_Castable_
        {
            [Fact]
            public void _Castable_Castable_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\Interop.ICastable\Castable\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"Castable.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"Castable.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\Castable\Castable.cmd");
