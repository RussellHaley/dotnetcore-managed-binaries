...
public class _LPSTR_LPSTRTest_LPSTRTest_
        {
            [Fact]
            public void _LPSTR_LPSTRTest_LPSTRTest_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\Interop.StringMarshalling\LPSTR\LPSTRTest\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"LPSTRTest.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"LPSTRTest.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\LPSTR\LPSTRTest\LPSTRTest.cmd");
