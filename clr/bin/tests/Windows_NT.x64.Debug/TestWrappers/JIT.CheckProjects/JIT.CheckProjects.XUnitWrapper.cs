...
public class _CheckProjects_CheckProjects_
        {
            [Fact]
            public void _CheckProjects_CheckProjects_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\JIT.CheckProjects\CheckProjects\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"CheckProjects.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"CheckProjects.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\CheckProjects\CheckProjects.cmd");
