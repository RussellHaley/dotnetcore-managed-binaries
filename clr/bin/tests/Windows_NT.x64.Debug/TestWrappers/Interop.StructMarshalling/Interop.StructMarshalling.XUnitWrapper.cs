...
public class _PInvoke_MarshalStructAsLayoutSeq_MarshalStructAsLayoutSeq_
        {
            ...
            public void _PInvoke_MarshalStructAsLayoutSeq_MarshalStructAsLayoutSeq_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\Interop.StructMarshalling\PInvoke\MarshalStructAsLayoutSeq\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"MarshalStructAsLayoutSeq.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"MarshalStructAsLayoutSeq.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\PInvoke\MarshalStructAsLayoutSeq\MarshalStructAsLayoutSeq.cmd");
