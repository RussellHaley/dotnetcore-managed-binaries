...
public class _RuntimeWrappedException_RuntimeWrappedException_RuntimeWrappedException_
        {
            [Fact]
            public void _RuntimeWrappedException_RuntimeWrappedException_RuntimeWrappedException_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\baseservices.compilerservices\RuntimeWrappedException\RuntimeWrappedException\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"RuntimeWrappedException.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"RuntimeWrappedException.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\RuntimeWrappedException\RuntimeWrappedException\RuntimeWrappedException.cmd");
