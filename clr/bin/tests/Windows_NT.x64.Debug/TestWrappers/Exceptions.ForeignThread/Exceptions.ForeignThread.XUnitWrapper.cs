...
public class _ForeignThreadExceptions_ForeignThreadExceptions_
        {
            [Fact]
            public void _ForeignThreadExceptions_ForeignThreadExceptions_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\Exceptions.ForeignThread\ForeignThreadExceptions\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"ForeignThreadExceptions.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"ForeignThreadExceptions.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\ForeignThreadExceptions\ForeignThreadExceptions.cmd");
