...
public class _0014_avtest_avtest_
        {
            [Fact]
            public void _0014_avtest_avtest_cmd()
            {
                int ret = -100;
                ...
                try
                {
                  ...
                  string testSubfolder = @"\Regressions.coreclr\0014\avtest\";
                  ...
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\0014\avtest\avtest.cmd");
