...
public class _mainv1_mainv1_
        {
            ...
            public void _mainv1_mainv1_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\readytorun.tests\mainv1\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"mainv1.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"mainv1.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\mainv1\mainv1.cmd");
...
public class _mainv2_mainv2_
        {
            ...
            public void _mainv2_mainv2_cmd()
            {
                ...
                {
                  CoreclrTestWrapperLib wrapper = new CoreclrTestWrapperLib();
                  string testSubfolder = @"\readytorun.tests\mainv2\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"mainv2.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"mainv2.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\mainv2\mainv2.cmd");
