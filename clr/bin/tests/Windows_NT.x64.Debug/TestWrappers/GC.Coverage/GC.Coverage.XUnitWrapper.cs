...
public class _LargeObjectAlloc2_LargeObjectAlloc2_
        {
            [Fact]
            public void _LargeObjectAlloc2_LargeObjectAlloc2_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\GC.Coverage\LargeObjectAlloc2\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"LargeObjectAlloc2.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"LargeObjectAlloc2.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\LargeObjectAlloc2\LargeObjectAlloc2.cmd");
...
public class _LargeObjectAlloc_LargeObjectAlloc_
        {
            ...
            public void _LargeObjectAlloc_LargeObjectAlloc_cmd()
            {
                ...
                {
                  CoreclrTestWrapperLib wrapper = new CoreclrTestWrapperLib();
                  string testSubfolder = @"\GC.Coverage\LargeObjectAlloc\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"LargeObjectAlloc.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"LargeObjectAlloc.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\LargeObjectAlloc\LargeObjectAlloc.cmd");
