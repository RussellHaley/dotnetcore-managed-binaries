...
public class _DeadThreads_DeadThreads_DeadThreads_
        {
            ...
            public void _DeadThreads_DeadThreads_DeadThreads_cmd()
            {
                ...
                try
                {
                  ...
                  string testSubfolder = @"\baseservices.threading\DeadThreads\DeadThreads\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"DeadThreads.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"DeadThreads.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\DeadThreads\DeadThreads\DeadThreads.cmd");
...
public class _paramthreadstart_ThreadStartBool_ThreadStartBool_
        {
            [Fact]
            public void _paramthreadstart_ThreadStartBool_ThreadStartBool_cmd()
            {
                ...
                {
                  CoreclrTestWrapperLib wrapper = new CoreclrTestWrapperLib();
                  string testSubfolder = @"\baseservices.threading\paramthreadstart\ThreadStartBool\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"ThreadStartBool.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"ThreadStartBool.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\paramthreadstart\ThreadStartBool\ThreadStartBool.cmd");
...
public class _paramthreadstart_ThreadStartBool_1_ThreadStartBool_1_
        {
            [Fact]
            public void _paramthreadstart_ThreadStartBool_1_ThreadStartBool_1_cmd()
            {
                ...
                {
                  CoreclrTestWrapperLib wrapper = new CoreclrTestWrapperLib();
                  string testSubfolder = @"\baseservices.threading\paramthreadstart\ThreadStartBool_1\";
                  outputFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"ThreadStartBool_1.output.txt");
                  errorFile = System.IO.Path.GetFullPath(_Global.reportBase + testSubfolder + @"ThreadStartBool_1.error.txt");
                  testExecutable = System.IO.Path.GetFullPath(_Global.testBinaryBase + @"\paramthreadstart\ThreadStartBool_1\ThreadStartBool_1.cmd");
