...
then
    echo $CORE_ROOT/corerun "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../../../dasm/JIT/jit64/opt/regress/vswhidbey/223862/conv_dbg conv_dbg.exe
    "$CORE_ROOT/corerun" "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../../../dasm/JIT/jit64/opt/regress/vswhidbey/223862/conv_dbg conv_dbg.exe
    _jdExitCode=$?
    if [ $_jdExitCode -ne 0 ]
    then
