...
then
    echo $CORE_ROOT/corerun "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../dasm/JIT/Directed/Misc/gettype/gettypetypeofmatrix gettypetypeofmatrix.exe
    "$CORE_ROOT/corerun" "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../../../dasm/JIT/Directed/Misc/gettype/gettypetypeofmatrix gettypetypeofmatrix.exe
    _jdExitCode=$?
    if [ $_jdExitCode -ne 0 ]
    then
