...
then
    echo $CORE_ROOT/corerun "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../dasm/Exceptions/Finalization/Finalizer Finalizer.exe
    "$CORE_ROOT/corerun" "$CORE_ROOT/jit-dasm.dll" --crossgen $CORE_ROOT/crossgen --platform $CORE_ROOT --output ../../../dasm/Exceptions/Finalization/Finalizer Finalizer.exe
    _jdExitCode=$?
    if [ $_jdExitCode -ne 0 ]
    then
